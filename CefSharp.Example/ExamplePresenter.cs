...
namespace CefSharp.Example
{
    public class ExamplePresenter : IRequestHandler, ICookieVisitor
    {
        ...
        private const string home_url = "https://wx.qq.com";
        ...
        void IRequestHandler.OnResourceResponse(IWebBrowser browser, string url, int status, string statusText, string mimeType, WebHeaderCollection headers,string content)
        {
            if (status == 200)
            {
                Console.WriteLine(headers+"====="+mimeType);
            }
        }
